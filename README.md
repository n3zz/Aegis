...
- Introduction to threat detection engineering
- Introduction to tooling that we will use
...
- Go
- JavaScript (TypeScript when this project gains a bit more traction again!)
- Python
...
- AWS (Will be looking into branching out to Azure as well!)

Everything will start with the free tier and then eventually when this project becomes more fleshed out there will be a more pub-sub architecture. But prices will be reasonable and will provide people a platform to (hopefully!) kickstart their career within Blue teaming!

**Security Tooling**: Trying to also learn something similar to what Monzo do for their Security pipeline which is within their [Response Github](https://github.com/monzo/response)
